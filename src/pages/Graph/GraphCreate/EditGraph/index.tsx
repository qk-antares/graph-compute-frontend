...
import {useMenuConfig} from "@/pages/Graph/GraphCreate/EditGraph/config/menu-config";
import {useCmdConfig} from "@/pages/Graph/GraphCreate/EditGraph/config/cmd-config";
import {useKeybindingConfig} from "@/pages/Graph/GraphCreate/EditGraph/config/keybinding-config";
import {DndNode} from "@/pages/Graph/GraphCreate/EditGraph/Node/DndNode";
...
const EditGraph: React.FC = () => {
  ...
  const handleOk = () => {
    ...
    //todo: 请求后端，保存到数据库，目前暂存在localStorage
  ...
  return (
    <div className="container">
      ...
      <Modal title="设置图的名称" open={visible} onOk={handleOk} onCancel={()=>setVisible(false)}>
